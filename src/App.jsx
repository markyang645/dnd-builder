...
import {
  CharacterTab, ClassTab, StatsTab, DetailsTab, ExportTab, CustomTab, CharacterSheetTab
...
const tabs = [
  ...
  { key: 'sheet', label: 'CHAR SHEET', gradient: 'from-green-600 to-green-400' },
...
function App() {
  ...
  const renderTab = () => {
    switch (activeTab) {
      ...
      case 'sheet': return <CharacterSheetTab />;
